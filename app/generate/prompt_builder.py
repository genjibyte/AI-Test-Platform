...
SYSTEM_PROMPT = (
    ...
    "- For overloaded methods, never pass bare null or untyped arrays; cast "
    "nulls ((String) null, (Boolean) null) and use typed arrays "
    "(new boolean[]{true}, new Boolean[]{Boolean.TRUE}). Ambiguous overloads do "
    "not compile.\n"
    ...
    "- For primitive and boxed overloads on varargs, positive-path calls MUST "
    "use a named typed array variable: boolean[] values = {true,true}; "
    "BooleanUtils.and(values); Boolean[] boxedValues = {Boolean.TRUE}; "
    ...
    "may be conditional; do NOT assertThrows from it alone. Otherwise SKIP into "
    "omitted_uncertain_cases.\n"
    "- Do not infer post-construction field/state from constants or Javadoc "
    "alone; use target source, neighbor test, or constructor body. If Javadoc "
    "conflicts with return type/source, SKIP; do not assert the documented "
    "value.\n"
    ...
    "target source or neighbor test; otherwise SKIP.\n"
